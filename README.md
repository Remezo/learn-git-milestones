...
- **Classes** - This milestone is made to use with multiple classes; insert your own class name where you see `<DIG -245>` (e.g. `dig245-critical-web-design`)
...
- [x] ✏️ This displays a help file with a list of possible commands. What does `log` do? **show commit logs**
...
- [x] Install [Github Desktop](https://desktop.github.com/)
	...
	- [x] Local Path: Click "Choose" and add a new folder on your computer. This will be the base folder for your work in this class: `dig245-critical-web-desig>`
...
- [x] Use the CLI to navigate directories  
  ...
  - [x] Open this README file in Atom and paste that path here: **C:\Users\miremezo\repo\.git**
...
- [x] Set up a [Github page](https://pages.github.com/) "project site" for your repo
  ...
  - [x] ✏️ Paste this link here: https://remezo.github.io/my-awesome-project/
